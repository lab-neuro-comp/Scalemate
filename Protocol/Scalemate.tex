...
The download consists of a compressed folder which, once extracted, contains an executable, made to run on computers running Microsoft Windows Vista onwards with at least 512MB of RAM memory, and two folders: \textit{assets} and \textit{results}.
